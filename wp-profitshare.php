    ...
    if (!empty($links)) {
        ...
        foreach ($links as $link) {
            ...
            if ($link->tip_display == 'y') {
                ...
                $newText .= $link->tip_description . "<div class='ttlast'>WP Profitshare 1.3.2</div></span></a>";
            } else {
...
function ps_account_settings() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="">
            <table class="form-table">
                <tr>
                    ...
                    <td><input id="api_user" class="regular-text" type="text" name="api_user" value="<?php
                        echo $ps_api_user . '"';
                        echo $disabled;
                        ?> /></td>
                               </tr>
                    ...
                    <td><input id="api_key" class="regular-text" type="text" name="api_key" value="<?php
                        echo $ps_api_key . '"';
                        echo $disabled;
                        ?> /></td>
                               </tr>
        ...
        if ($is_api_connected) {
            ...
            <form action="" method="post" style="display: inline;">
                <input type="submit" name="links_in_pages" id="<?php echo $form_page['css_id']; ?>" value="<?php echo $form_page['input_value']; ?>" />
            </form>
...
function ps_tag_image() {
    ...
    <div class="wrap">
        ...
        <hr style="border-top: 1px dashed #7f8c8d;">
        <h2>Tag Image 
            <a href="<?php echo admin_url('admin.php?page=ps_tag_image&do=add'); ?>" style="background: #FFF; font-size: 12px; padding: 4px; text-decoration: none; border-radius: 3px;">Add image</a>
            <?php if (!empty($_REQUEST['do']) && $_REQUEST['do'] != 'delete') { ?><a href="<?php echo admin_url('admin.php?page=ps_tag_image'); ?>" style="background: #FFF; font-size: 12px; padding: 4px; text-decoration: none; border-radius: 3px;">Show images list</a><?php } ?>
        </h2>
        <?php
        $show_table = true;
        $errors = array();
                            ...
                            <table class="form-table">
                                <tbody>
                                    <tr valign="top">
                                        <th scope="row"><label for="title">Title</label></th>
                                        <td>
                                            <input class="large-text" type="text" name="title" value="<?php echo!empty($_POST['title']) ? esc_attr($_POST['title']) : esc_attr($row['title']); ?>" />
                                        </td>
                                    </tr>
                                    <tr valign="top">
                        ...
                        <table class="form-table">
                            <tbody>
                                <tr valign="top">
                                    <th scope="row"><label for="title">Title</label></th>
                                    <td>
                                        <input class="large-text" type="text" name="title" value="<?php echo!empty($_POST['title']) ? esc_attr($_POST['title']) : ''; ?>" />
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <th scope="row"><label for="image">Image</label></th>
